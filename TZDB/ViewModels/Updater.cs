...
namespace NUIClockUpdater.ViewModels
{
    public class Updater : UINotifications, System.IDisposable
    {
        #region Constants
        /// <summary>
        /// The default connection string to display, for the user to change.
        /// </summary>
        ...
        #region Fields
        /// <summary>
        /// Utility to parse the olson database files to be uploaded.
        /// </summary>
        private OlsonParser _olsonParser;

        /// <summary>
        /// Utility to parse the geonames database files to be uploaded.
        /// </summary>
        ...
        /// <summary>
        /// The current connection string being used to connect to the Database.
        /// </summary>
        ...
        /// <summary>
        /// Object used to lock concurrent access to the cities table.
        /// </summary>
