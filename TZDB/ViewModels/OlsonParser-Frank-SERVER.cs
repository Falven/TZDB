        ...
        public void ReadTZDirectory()
        {
            try
            {
                                    ...
                                    case Rule.RULE_NAME:
                                        {
                                            ...
                                            // Must parse type before time.
                                            char type = Rule.ParseTimeType(ref fields[Rule.AtIndex]);
                                            System.TimeSpan time = Rule.ParseTime(fields[Rule.AtIndex]);
                                    ...
                                    case TimeZone.ZONE_NAME:
                                        {
                                            ...
                                            {
                                                App.ExceptionLogger.LogLow(new System.Exception("OlsonParser.cs Ln 335:"
                ...
                foreach (string[] link in _links)
                {
                    ...
                    if (!TimeZoneLookupTable.TryGetValue(link[0], out from))
                    {
