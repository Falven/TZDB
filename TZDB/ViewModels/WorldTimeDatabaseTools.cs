...
namespace NUIClockUpdater.ViewModels
{
    public class WorlTimeDatabaseTools
    {
        ...
        private const string LEAP_TABLE_NAME = "leaps";
        ...
        /// <summary>
        /// Creates and returns a new Leap DataTable.
        /// </summary>
        /// <returns>A new Leap DataTable.</returns>
        public DataTable GetLeapDataTable()
        {
            DataTable leapDataTable = new DataTable(LEAP_TABLE_NAME, TABLE_SCHEMA);
            leapDataTable.Columns.Add("id", typeof(int));
            leapDataTable.Columns.Add("year", typeof(short));
            leapDataTable.Columns.Add("month", typeof(string));
            leapDataTable.Columns.Add("day", typeof(short));
            leapDataTable.Columns.Add("time", typeof(System.TimeSpan));
            leapDataTable.Columns.Add("correction", typeof(char));
            leapDataTable.Columns.Add("rs", typeof(char));
            leapDataTable.Columns.Add("version", typeof(Binary));
            return leapDataTable;
        }
        ...
        /// <summary>
        /// Creates the appropriate TimeZone, Rule, Leap, and City Database tables on the Database.
        /// </summary>
        public void CreateOlsonDatabaseTables()
        {
            ...
            commandBuilder.Append(";\n");
            commandBuilder.Append("\nIF OBJECT_ID('");
            commandBuilder.Append(LEAP_TABLE_NAME);
            commandBuilder.Append("', 'U') IS NOT NULL\n");
            commandBuilder.Append("\tDROP TABLE ");
            commandBuilder.Append(LEAP_TABLE_NAME);
            commandBuilder.Append(";\n");
            ...
            commandBuilder.Append("\n(\n");
            commandBuilder.Append("\t[id] INT NOT NULL IDENTITY PRIMARY KEY,\n");
            commandBuilder.Append("\t[year] SMALLINT NOT NULL,\n");
            commandBuilder.Append("\t[month] VARCHAR(3),\n");
            commandBuilder.Append("\t[day] SMALLINT NOT NULL,\n");
            commandBuilder.Append("\t[time] TIME(0) NOT NULL,\n");
            commandBuilder.Append("\t[correction] VARCHAR(1) NOT NULL,\n");
            commandBuilder.Append("\t[rs] VARCHAR(1) NOT NULL,\n");
            commandBuilder.Append("\t[version] BINARY(8)\n);\n");
